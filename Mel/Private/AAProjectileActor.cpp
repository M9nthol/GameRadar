...
void AAAProjectileActor::PlayFlightSound()
{
    if (FlightSound)
    {
        UGameplayStatics::PlaySoundAtLocation(this, FlightSound, GetActorLocation());
    }
}

void AAAProjectileActor::PlayExplosionSound()
{
    if (ExplosionSound)
    {

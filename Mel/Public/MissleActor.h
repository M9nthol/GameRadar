...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnMissleDestroyed);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnMissleReachedTarget);
...
public:
    ...
    FOnMissleDestroyed OnMissleDestroyed;

    UPROPERTY(BlueprintAssignable, Category = "Events")
    FOnMissleReachedTarget OnMissleReachedTarget;
